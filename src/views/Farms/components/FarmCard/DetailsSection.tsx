...
const DetailsSection: React.FC<ExpandableSectionProps> = ({
  ...
  let externalLink = isTokenOnly ?
    `https://cchain.explorer.avax.network/address/${tokenAddresses[process.env.REACT_APP_CHAIN_ID]}`
    :
    `https://cchain.explorer.avax.network/address/${liquidityUrlPathParts}`;
