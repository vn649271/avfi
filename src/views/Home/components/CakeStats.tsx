  ...
  return (
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          <Text fontSize="14px" color="#FFFFFF">Boost</Text>
          <Text bold fontSize="14px" color="#ea0303">ON</Text>
        </Row>
        <Row>
		...
		<Row>
          ...
          <CardValue fontSize="14px" value={11000} decimals={0} />
        </Row>
        <Row>
          <Text fontSize="14px" color="#FFFFFF">New Terra Per Second</Text>
          <Text bold fontSize="14px" color="#FFFFFF">{terraPerSec}</Text>
        </Row>
      </CardBody>
    </StyledCakeStats>
  )
